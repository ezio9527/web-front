  ...
  <div class="login_form app-download">
    <div class="login_right">
      <div style="color: #000;margin-bottom: 60px;padding-top: 160px;width: 100%;text-align:center;z-index: 10;">
        ...
        <p style="font-size:18px;">Bihuo</p>
    ...
    <div class="section" id="page4">
      <ul>
        <li>
          <div><img src="https://bihuo.oss-ap-southeast-1.aliyuncs.com/2019/download1.png" alt=""></div>
          <p class="title">极致体验</p>
          <p>精心优化的界面显示，体验流畅的操作响应</p>
        </li>
        <li>
          <div><img src="https://bihuo.oss-ap-southeast-1.aliyuncs.com/2019/download2.png" alt=""></div>
          <p class="title">币种行情</p>
          <p>支持MACD、KDJ、RSI、BOLL等多种专业指标</p>
        </li>
        <li>
          <div><img src="https://bihuo.oss-ap-southeast-1.aliyuncs.com/2019/download5.png" alt=""></div>
          <p class="title">币币交易</p>
          <p>支持限价委托与市价委托两种方式</p>
        </li>
        <li>
          <div><img src="https://bihuo.oss-ap-southeast-1.aliyuncs.com/2019/download3.png" alt=""></div>
          <p class="title">法币交易</p>
          <p>优质承兑商，保证资金通道顺畅无阻</p>
        </li>
        <li>
          <div><img src="https://bihuo.oss-ap-southeast-1.aliyuncs.com/2019/download4.png" alt=""></div>
    ...
    <div class="cover" id="cover" @click="coverClick"><img src="https://bihuo.oss-ap-southeast-1.aliyuncs.com/2019/appdowncover.png"></img></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    init() {
      window.document.title = (this.lang == "简体中文" ? "APP下载 - " : "APP Download - ") + "Bihuo | 全球比特币交易平台 | 全球数字货币交易平台";
      this.getVersion();
    },
    downloadClick(){
      if(this.isWeiXin()){
        ...
        location.href = "https://bihuo.oss-ap-southeast-1.aliyuncs.com/appdownload/eotech-release.apk";
      }
    },
    downloadClick2(){
      if(this.isWeiXin()){
