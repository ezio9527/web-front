<template>
  <div class="envelope">
    ...
    <p style="margin-top: -80px;margin-bottom: 80px;text-align:center;color: rgb(255, 136, 79);font-size:13px;">该红包通过Bihuo发出</p>
    ...
    <router-link style="font-size:14px;text-align:center;color: #EEE;margin-top:15px;text-decoration:underline;" to="/app">© Bihuo | 下载APP</router-link>
    </p>
...
export default {
  data() {
    return {
      ...
      hasInviteUser: false,
      inviteUserId: "***********",
      inviteUserAvatar: "https://bihuo.oss-ap-southeast-1.aliyuncs.com/defaultavatar.png",
      envelopeInfo: {
        id: 0,
        name: "**********",
        totalAmount: "0.00",
        ...
        invite: 0,
        type: 0,
        logo: "https://bihuo.oss-ap-southeast-1.aliyuncs.com/applogo.png",
        bgImage: "https://bihuo.oss-ap-southeast-1.aliyuncs.com/redenvelope.png",
        state: 0,
        detail: "留给未来一个暴富的可能"
      },
      formInline: {
    ...
    getEnvelope(){
        ...
        this.$http.post(this.host + "/uc/redenvelope/query", param).then(res => {
          ...
          if (res.status == 200 && res.body.code == 0) {
            ...
            window.document.title = "【" + this.envelopeInfo.totalAmount + " " + this.envelopeInfo.unit + "】" + this.envelopeInfo.name + "  — Bihuo交易所"
            this.getEnvelopeDetailList();
          } else {
              this.$Message.error(res.body.message);
          }
